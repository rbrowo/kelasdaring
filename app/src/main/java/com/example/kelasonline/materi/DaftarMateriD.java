...
public class DaftarMateriD extends AppCompatActivity {
    ...
    MateriAdapter.RecyclerViewClickListener listener;
    ProgressBar progressBar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_daftar_materid);
        ...
        listener = new MateriAdapter.RecyclerViewClickListener() {
            @Override
            public void onRowClick(View view, int position) {
                String nama = tvNama.getText().toString();
                String email = tvEmail.getText().toString();
                Intent intent = new Intent(DaftarMateriD.this, EditorMateriD.class);
                intent.putExtra("id", materiList.get(position).getId());
                intent.putExtra("matkul", materiList.get(position).getMatkul());
                intent.putExtra("topik", materiList.get(position).getTopik());
                intent.putExtra("materi", materiList.get(position).getMateri());
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(DaftarMateriD.this, EditorMateriD.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_home:
                ...
                Intent i = new Intent(DaftarMateriD.this, HomeDosen.class);
                i.putExtra("result_nama", nama);
                i.putExtra("result_email", email);
                startActivity(i);
                return true;
    ...
    public void getMateri(){
        ...
        Call<List<Materi>> call = apiInterface.getMateri();
        call.enqueue(new Callback<List<Materi>>() {
            @Override
            public void onResponse(Call<List<Materi>> call, Response<List<Materi>> response) {
                progressBar.setVisibility(View.GONE);
                materiList = response.body();
                Log.i(DaftarMateriM.class.getSimpleName(), response.body().toString());
                adapter = new MateriAdapter(materiList, DaftarMateriD.this, listener);
            ...
            public void onFailure(Call<List<Materi>> call, Throwable t) {
                Toast.makeText(DaftarMateriD.this, "rp :"+
