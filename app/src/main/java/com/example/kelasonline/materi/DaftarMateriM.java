...
public class DaftarMateriM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_materim);
        ...
        listener = new MateriAdapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, int position) {
                ...
                Intent intent = new Intent(DaftarMateriM.this, EditorMateriM.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_home:
                ...
                Intent i = new Intent(DaftarMateriM.this, HomeMahasiswa.class);
    ...
    public void getMateri(){
        ...
        call.enqueue(new Callback<List<Materi>>() {
            ...
            public void onResponse(Call<List<Materi>> call, Response<List<Materi>> response) {
                ...
                adapter = new MateriAdapter(materiList, DaftarMateriM.this, listener);
            ...
            public void onFailure(Call<List<Materi>> call, Throwable t) {
                Toast.makeText(DaftarMateriM.this, "rp :"+
