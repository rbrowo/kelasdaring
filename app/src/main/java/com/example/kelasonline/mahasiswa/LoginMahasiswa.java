...
public class LoginMahasiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bRegister.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(mContext, RegisterMahasiswa.class));
            }
        });
    ...
    public void requestLogin(){
        mApiService.loginMhsRequest(txtNIM.getText().toString(), txtPassword.getText().toString())
                        ...
                        if (response.isSuccessful()){
                            ...
                            try {
                                ...
                                if(jsonRESULTS.getString("error").equals("false")){
                                    ...
                                    Intent i = new Intent(mContext, HomeMahasiswa.class);
