...
public class DaftarTanyaM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_tanyam);
        ...
        listener = new TanyaJawabAdapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, int position) {
                ...
                Intent intent = new Intent(DaftarTanyaM.this, EditorJawabanM.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(DaftarTanyaM.this, TanyaDosen.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_home:
                ...
                Intent i = new Intent(DaftarTanyaM.this, HomeMahasiswa.class);
                i.putExtra("result_nama", nama);
                i.putExtra("result_email", email);
                startActivity(i);
                return true;
    ...
    public void getTanya(){
        ...
        call.enqueue(new Callback<List<TanyaJawab>>() {
            ...
            public void onResponse(Call<List<TanyaJawab>> call, Response<List<TanyaJawab>> response) {
                ...
                adapter = new TanyaJawabAdapter(tanyaList, DaftarTanyaM.this, listener);
            ...
            public void onFailure(Call<List<TanyaJawab>> call, Throwable t) {
                Toast.makeText(DaftarTanyaM.this, "rp :"+
