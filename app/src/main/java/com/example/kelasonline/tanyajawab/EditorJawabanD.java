...
public class EditorJawabanD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.editor_jawaband);
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            readMode();
            getSupportActionBar().setTitle("Jawab Pertanyaan " + mhs.toString());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent i = new Intent(EditorJawabanD.this, DaftarTanyaD.class);
            ...
            case R.id.menu_edit:
                ...
                imm.showSoftInput(etJawaban, InputMethodManager.SHOW_IMPLICIT);
            ...
            case R.id.menu_delete:
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(EditorJawabanD.this);
                dialog.setMessage("Hapus Pertanyaan?");
                dialog.setPositiveButton("Ya" ,new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        startActivity(new Intent(EditorJawabanD.this, DaftarTanyaD.class));
        ...
        call.enqueue(new Callback<TanyaJawab>() {
            ...
            public void onResponse(Call<TanyaJawab> call, Response<TanyaJawab> response) {
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorJawabanD.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<TanyaJawab> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorJawabanD.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
